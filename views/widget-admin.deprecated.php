...
<p><label for="<?php echo $this->get_field_id('image'); ?>"><?php _e('Image', 'ads_widget'); ?>:</label>
	<?php
	...
	$image_title = (!empty($instance['image'])) ? __('Change Image', 'ads_widget') : __('Add Image', 'ads_widget');
	?><br />
	<a href="<?php echo $image_upload_iframe_src; ?>&TB_iframe=true" id="add_image-<?php echo $this->get_field_id('image'); ?>" class="thickbox-ads-widget" title='<?php echo $image_title; ?>' onClick="imageWidget.setActiveWidget('<?php echo $this->id; ?>');return false;" style="text-decoration:none"><img src='images/media-button-image.gif' alt='<?php echo $image_title; ?>' align="absmiddle" /> <?php echo $image_title; ?></a>
